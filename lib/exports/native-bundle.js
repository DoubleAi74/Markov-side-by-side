...
export class NativeExportUnsupportedError extends Error {}

export async function createNativeBundle(savedSimulation) {
  if (savedSimulation?.simulatorType === "discrete-time") {
    throw new NativeExportUnsupportedError(
      "Native runner export is not available for discrete-time models.",
    );
  }
